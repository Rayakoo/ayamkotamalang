    ...
    <>
      <section className="relative bg-gradient-to-br from-[#C41E1E] to-[#8B0000] py-16 sm:py-20 lg:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Link href="/produk" className="inline-flex items-center gap-1 text-white/70 hover:text-white text-sm mb-4 transition-colors">
            ← Semua Produk
          </Link>
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-right">
              <a
                ...
                className="inline-flex items-center gap-2 bg-white text-[#C41E1E] hover:bg-gray-100 font-semibold py-3 px-6 rounded-xl transition-colors shadow-lg"
              >
      ...
      <section className="bg-[#FAF5EE] py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link href="/produk" className="inline-flex items-center gap-1 bg-[#C41E1E] hover:bg-[#8B0000] text-white font-medium py-3 px-6 rounded-lg transition-colors">
