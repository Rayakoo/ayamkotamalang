...
export default function VideoPage() {
  ...
  return (
    <>
      {/* PAGE HEADER */}
      <section className="relative bg-gradient-to-b from-[#C41E1E] to-[#8B0000] py-16 sm:py-20 lg:py-28 overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-10 right-10 w-40 h-40 border border-white rounded-full" />
          <div className="absolute bottom-10 left-10 w-60 h-60 border border-white rounded-full" />
          <div className="absolute top-1/3 right-1/4 w-20 h-20 border border-white rounded-full" />
        </div>
      ...
      <section className="bg-[#FAF5EE] pt-8 pb-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-2">
            {['Semua', 'Produksi', 'Fasilitas', 'Testimoni', 'Produk', 'Edukasi'].map((cat) => (
              <button
                key={cat}
                className="px-5 py-2 text-sm font-medium rounded-full bg-white text-[#1A1A1A] border border-gray-200 hover:border-[#C41E1E] hover:text-[#C41E1E] transition-all"
              >
                {cat}
              </button>
            ))}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {videos.map((v, i) => (
              <div key={v.title} className="group cursor-pointer" data-aos="fade-up" data-aos-delay={(i % 3) * 100}>
                <div className="aspect-video bg-gray-800 rounded-xl overflow-hidden relative flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
                  <div className="text-center p-6">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#C41E1E]/20 flex items-center justify-center group-hover:bg-[#C41E1E]/40 transition-colors">
      ...
      <section className="bg-[#1A1A1A] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-base sm:text-lg mb-8" data-aos="fade-up">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#C41E1E] hover:bg-[#8B0000] text-white font-semibold py-3.5 px-8 rounded-xl transition-colors shadow-lg"
            data-aos="fade-up"
          >
