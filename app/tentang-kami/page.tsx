...
export default function TentangKami() {
  return (
    <>
      {/* PAGE HEADER */}
      <section className="relative bg-[#C41E1E] py-16 sm:py-20 lg:py-28 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div data-aos="fade-right">
              <h2 className="font-heading font-bold text-2xl sm:text-3xl text-[#1A1A1A] mb-6">
            ...
            <div className="relative" data-aos="fade-left">
              ...
              <div className="absolute -bottom-4 -left-4 bg-[#C41E1E] text-white text-sm font-bold px-5 py-2.5 rounded-lg shadow-lg">
                55+ Tahun Pengalaman
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#FAF5EE] py-14 sm:py-18">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: '🏆', number: '55+', label: 'Tahun Pengalaman', desc: 'Berdiri sejak 1970' },
              { icon: '🤝', number: '50+', label: 'Klien B2B', desc: 'Hotel, restoran & kafe' },
              { icon: '✅', number: '100%', label: 'Halal Certified', desc: 'Sertifikat resmi MUI' },
              { icon: '❄️', number: '2', label: 'Varian Produk', desc: 'Fresh & Frozen' },
            ].map((s, i) => (
              <div key={s.label} className="bg-white rounded-xl p-6 sm:p-8 text-center shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" data-aos-delay={i * 100}>
                <span className="text-3xl sm:text-4xl">{s.icon}</span>
                <div className="font-heading font-bold text-3xl sm:text-4xl text-[#C41E1E] mt-3">{s.number}</div>
      ...
      <section className="bg-[#1A1A1A] py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <h2 className="font-heading font-bold text-2xl sm:text-3xl lg:text-4xl text-white mt-3" data-aos="fade-up">
              Lihat Proses Produksi Kami
            </h2>
            <p className="text-gray-400 text-base sm:text-lg mt-3 max-w-2xl mx-auto" data-aos="fade-up">
            ...
            {[
              ...
              <div key={v.title} className="relative group" data-aos="fade-up" data-aos-delay={i * 100}>
                <div className="aspect-video bg-gray-800 rounded-xl overflow-hidden flex items-center justify-center">
                  <div className="text-center p-6">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#C41E1E]/20 flex items-center justify-center group-hover:bg-[#C41E1E]/30 transition-colors cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <div className="space-y-6" data-aos="fade-right">
              <div className="bg-[#FAF5EE] rounded-xl p-5 sm:p-6">
                ...
                <a href="https://maps.google.com/?q=Jalan+Kebalen+Wetan+53A+Kedungkandang+Kota+Malang" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-[#C41E1E] text-sm font-medium mt-2 hover:underline">
                  Buka di Google Maps →
                </a>
              </div>
              <div className="bg-[#FAF5EE] rounded-xl p-5 sm:p-6">
                ...
                <a href="https://maps.google.com/?q=Jalan+Terusan+Agus+Salim+No+2+Temas+Kota+Batu" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-[#C41E1E] text-sm font-medium mt-2 hover:underline">
                  Buka di Google Maps →
                </a>
              </div>
            ...
            <div className="rounded-xl overflow-hidden shadow-lg h-[350px] sm:h-[400px]" data-aos="fade-left">
              <iframe
