        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-[#C41E1E] rounded-lg flex items-center justify-center text-white font-heading font-bold text-xs">
                AKM
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:0341351691" className="text-gray-400 hover:text-[#C41E1E] text-sm transition-colors duration-200 flex items-center gap-2">
                  📞 0341 351-691
                </a>
              </li>
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-[#C41E1E] text-sm transition-colors duration-200 flex items-center gap-2"
                >
                  📱 0838-3200-0098
                </a>
              </li>
              ...
              <li className="text-gray-400 text-sm leading-relaxed">
                <span className="flex items-start gap-2">
                  📍 Jl. Kebalen Wetan 53A, Kedungkandang, Kota Malang
                </span>
              </li>
            </ul>
          </div>
